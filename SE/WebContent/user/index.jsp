...
a:Link       { color: #208000; font-family: "Tahoma,宋体"; 
			font-weight:700;
font-size:20px;
		 text-decoration: none;}
a:visited    { color:#208000; font-family: "Tahoma,宋体"; 
font-weight:700;
font-size:20px;
text-decoration: none;}
a:hover      { color: #208000; font-family: "Tahoma,宋体"; 
font-weight:700;
font-size:20px;
 text-decoration: underline;}
a:active     { color: #208000; font-family: "Tahoma,宋体";  
font-weight:700;
font-size:20px;
text-decoration: none;}
a            { color: #208000;
...
<script type="text/javascript">
		...
		<TABLE WIDTH="772" BORDER="0" height="79" align="center"
			...
			<TR>
				...
				<td WIDTH="78" align="center">
					...
					<s:a target="rightFrame" action="userppt!showPptList.action?pagecode=1">
							电子教程
					</s:a>				
				</td>
	...
	<div id="status">
			<table align="center" border="0" width="773" cellspacing="0" cellpadding="0"
				height="31" background="image/main/hengMenuBG.jpg">
				<tr>
					<td width="595">
						<p align="left">
							欢迎访问软件工程学习网站！
	...
	<div id="main">
		<table border="0" cellpadding="0" cellspacing="0" height="600px">
			<tr>
				...
				<div id="right">
					<iframe id="rightFrame" src="user/first.jsp" name="rightFrame" width="100%" frameborder="0" height="0" scrolling="no"
