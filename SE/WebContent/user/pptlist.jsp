...
#banner{
  ...
  <body >
  	...
  	<s:if test="#lst==null">
  		<center>
  			<font color="#ff0000" size="12px">暂无电子教程</font>
  		</center>
  	</s:if>
  	<s:else>
             ...
             <td height="30px;">
          	<table width="100%" border="0" cellspacing="0" cellpadding="0">
          	   <tr>
					...
					<s:a href="ppt!showPptList.action?pagecode=1">
						首页
					</s:a>
					
					<s:if test="#request.pagecode!=1">

					    <s:a href="ppt!showPptList.action?pagecode=%{#request.pagecode-1}">
					...
					<s:a targets="right" href="ppt!showPptList.action?pagecode=%{#request.pages}">
						最后一页
					</s:a>
          	   		</div>
          	   		</td>
