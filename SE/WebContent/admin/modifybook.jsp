          		...
          		<td>
					...
					<tr height="50px">
						...
						<td bgcolor="#ffffff"  width="60px" colspan="2">
							<div class="style2">
								<s:textfield name="name" value="%{#book.name}" theme="simple"></s:textfield>
							</div>
						</td >
					</tr>
					<tr>
						...
						<td bgcolor="#ffffff" align="center" width="150px">
							<div class="style2">
								<img src="<s:property value='#book.path'/>" width="100%" height="100px">
							</div>
						</td >
					...
					<tr>
						...
						<td bgcolor="#ffffff" width="200px" colspan="2">			
							 <div class="style2">
									 <s:textarea name="description" value="%{#book.description}" theme="simple" id="txt"></s:textarea>
							 </div>
						</td>
					</tr>
					<tr height="50px">
